(function(){
  ...
  async function load(){
    ...
    loading=Promise.all([import(URLS.jq),import(URLS.core),import(URLS.ai),import(URLS.ui)]).then(([jq,core,ai,ui])=>{
      const $=jq.default||jq.jQuery||jq;
  ...
  async function start(){
    ...
    const root=$('#fnMahjongRoot'),board=$('#board',root),pai=Majiang.UI.pai($('#loaddata',root)),audio=Majiang.UI.audio($('#loaddata',root));
